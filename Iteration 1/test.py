    ...
    def leadReset():
        try:
            ...
            if conn.is_connected():
                ...
                command = "select si_no from leaderboard;"
                print(command)
        ...
        for i in siList:
            try:
                ...
                if conn.is_connected():
                    ...
                    command1 = "delete from leaderboard where si_no = "+str(i)+";"
                    print(command1)
                    cursor.execute(command1)
        ...
        def gameOver():
            ...
            try:
                ...
                if conn.is_connected():
                    ...
                    command1 = "update leaderboard set streak = "+finalStreak+" where si_no = "+str(currentSI)+";"
                    print(command1)
                    cursor.execute(command1)

                    updatedSI = currentSI + 1
                    print(updatedSI)
                    command2 = "insert into leaderboard(si_no) values ("+str(updatedSI)+");"
                    print(command2)
                    cursor.execute(command2)
            ...
            if ('#FFDE00' in colour)==False and ('#4B4B4B' in colour)==False:
                ...
                try:
                    ...
                    if conn.is_connected():
                        ...
                        command = "insert into streak_number values ("+str(updateStreak)+");"
                        print(command)
                        cursor.execute(command)
